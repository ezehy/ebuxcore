/* src/config/ebux-config.h.  Generated from ebux-config.h.in by configure.  */
/* src/config/ebux-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EBUX_CONFIG_H

#define EBUX_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.ebux.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "eBux Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "eBux Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ebux"
