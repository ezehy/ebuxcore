...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* eBux features */
        {"ebux", "masternode", &masternode, true, true, false},
        {"ebux", "listmasternodes", &listmasternodes, true, true, false},
        {"ebux", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ebux", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ebux", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ebux", "masternodedebug", &masternodedebug, true, true, false},
        {"ebux", "startmasternode", &startmasternode, true, true, false},
        {"ebux", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ebux", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ebux", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ebux", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ebux", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ebux", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ebux", "mnbudget", &mnbudget, true, true, false},
        {"ebux", "preparebudget", &preparebudget, true, true, false},
        {"ebux", "submitbudget", &submitbudget, true, true, false},
        {"ebux", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ebux", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ebux", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ebux", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ebux", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ebux", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ebux", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ebux", "checkbudgets", &checkbudgets, true, true, false},
        {"ebux", "mnsync", &mnsync, true, true, false},
        {"ebux", "spork", &spork, true, true, false},
        {"ebux", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ebux", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ebuxd, or the -server option to ebux-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"eBux Alert\" admin@foo.com\n"),
...
{
    return "> ebux-cli " + methodname + " " + args + "\n";
}
