...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0xeed9fa7c57fe7290a5c19be35d86ab93e56639e3f6822604f9d4e5441bd406c8"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 16340;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 eBux starting difficulty is 1 / 2^12
        ...
        nTargetSpacingSlowLaunch = 10 * 60;  // eBux: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 90;  
        nMaturity = 49;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 9990000000 * COIN;
        ...
        const char* pszTimestamp = "Let it begin - the game has started";
        ...
        assert(hashGenesisBlock == uint256("0xeed9fa7c57fe7290a5c19be35d86ab93e56639e3f6822604f9d4e5441bd406c8"));
        assert(genesis.hashMerkleRoot == uint256("0x86e42d6461203b3ad28e1def18878d5bb3afd42da17a17f90e0b802fd30bc11f"));

    		  vSeeds.push_back(CDNSSeedData("seed1", "80.211.105.199")); 
          vSeeds.push_back(CDNSSeedData("seed2", "212.237.23.36")); 
          vSeeds.push_back(CDNSSeedData("seed3", "142.93.247.30")); 
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // eBux: 1 day
        nTargetSpacing = 1 * 60;  // eBux: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet ebux addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ebux script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ebux BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ebux BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ebux BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // eBux: 1 day
        nTargetSpacing = 1 * 60;        // eBux: 1 minutes
