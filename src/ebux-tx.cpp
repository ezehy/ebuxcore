...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("eBux Core ebux-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ebux-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ebux transaction") + "\n" +
                               "  ebux-tx [options] -create [commands]   " + _("Create hex-encoded ebux transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ebux transaction
