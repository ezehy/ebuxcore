...
RESOURCES += src/qt/ebux.qrc src/qt/ebux_locale.qrc

TRANSLATIONS += src/qt/locale/ebux_bg.ts \
                src/qt/locale/ebux_de.ts \
                src/qt/locale/ebux_en.ts \
                src/qt/locale/ebux_es.ts \
                src/qt/locale/ebux_fi.ts \
                src/qt/locale/ebux_fr.ts \
                src/qt/locale/ebux_it.ts \
                src/qt/locale/ebux_ja.ts \
                src/qt/locale/ebux_pl.ts \
                src/qt/locale/ebux_pt.ts \
                src/qt/locale/ebux_ru.ts \
                src/qt/locale/ebux_sk.ts \
                src/qt/locale/ebux_sv.ts \
                src/qt/locale/ebux_vi.ts \
                src/qt/locale/ebux_zh_CN.ts \
                src/qt/locale/ebux_zh_TW.ts
