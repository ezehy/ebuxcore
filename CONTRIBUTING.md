Contributing to eBux Core
============================

The eBux Core project operates an open contributor model where anyone is
...
The following applies to code changes to the eBux Core project, and is not to be
confused with overall eBux Network Protocol consensus changes.

Whether a pull request is merged into eBux Core rests with the project merge
...
Patches that change eBux consensus rules are considerably more involved than
...
Where a patch set proposes to change the eBux consensus, it must have been
...
The project leader is the release manager for each eBux Core release.
